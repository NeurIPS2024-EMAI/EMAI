...
class Runner(object):
    def __init__(self, config):
        ...
        if self.all_args.algorithm_name == "happo":
            from mpe.algorithms.happo.happo_trainer import HAPPO as TrainAlgo
            from mpe.algorithms.happo.policy import HAPPO_Policy as Policy
        elif self.all_args.algorithm_name == "hatrpo":
            from mpe.algorithms.hatrpo.hatrpo_trainer import HATRPO as TrainAlgo
            from mpe.algorithms.hatrpo.policy import HATRPO_Policy as Policy
        else:
