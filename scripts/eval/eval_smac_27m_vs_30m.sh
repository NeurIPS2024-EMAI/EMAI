...
do
    ...
    --env_args.map_name 27m_vs_30m --run_mode Test --runner episode --batch_size_run 1 \
    ...
    --need_patch False --need_collect False --patch_budget 50 --diff_th 3 --ep_reward_th 19.5
done